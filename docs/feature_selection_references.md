...
- **Grover, A., Singh, R., & Singh, A. (2024).** Predicting land surface temperature and examining its relationship with air pollution and urban parameters in Bengaluru: A machine learning approach. _Urban Climate_, 53, 101783. [[DOI: 10.1016/j.uclim.2023.101783]](https://doi.org/10.1016/j.uclim.2023.101783)
  - _(งานวิจัยใหม่ที่ศึกษาความสัมพันธ์ในบริบทโซนเอเชียใต้ ยืนยันชัดเจนว่า LST มีความสัมพันธ์เชิงพื้นที่และเวลากับความเข้มข้นของมลพิษทางอากาศ (อาทิ CO, NO2) โดยการใช้ Machine Learning สามารถวิเคราะห์และพยากรณ์ได้ครอบคลุมกว่าแบบจำลองเชิงเส้น)_
